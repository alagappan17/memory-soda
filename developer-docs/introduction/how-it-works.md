...
See [The extraction pipeline](../concepts/extraction-pipeline.md) for each step
in detail.
...
[Your first integration](../getting-started/your-first-integration.md) for the
complete version.
...
- [Architecture](./architecture.md) — processes, tables, background jobs

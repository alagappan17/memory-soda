...
- [ ] `messageLimit` ≥ `autoCompactThreshold` if you enable compaction ([why](../guides/long-conversations.md))
...
- [Build a chatbot with memory](../guides/build-a-chatbot.md) — streaming, multi-user, production shape
- [SDK reference](../sdk/index.md)
- [Handling long conversations](../guides/long-conversations.md) — compaction

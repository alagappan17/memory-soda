...
1. Create a key on [API Keys](./api-keys.md).
...
[`POST /v1/threads/:id/end`](../api/threads.md#post-v1threadsthreadidend) and
...
### Recall
Run [`recall()`](../api/recall.md) by hand against the current dataset, with all
...
[`POST …/chat`](../api/working-memory.md#post-v1memoryworkingthreadsthreadidchat),
...
| Facts/Episodes tabs duplicate [Datasets](./datasets.md) | Same data, narrower view |
...
- [Datasets](./datasets.md) — the durable view of the same data
- [The extraction pipeline](../concepts/extraction-pipeline.md) — what you are watching

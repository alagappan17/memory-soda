...
Full field reference with bounds: [Project settings](../reference/project-settings.md).
...
[Playground](./playground.md), and compare recall output before and after. See
...
- [Project settings reference](../reference/project-settings.md) — bounds and validation
- [Tuning retrieval quality](../guides/tuning-retrieval.md) — how to change these safely
- [Playground](./playground.md) — where to experiment

...
> signs in to the UI. A [*dataset*](../concepts/projects-and-datasets.md) is the
...
- [Authentication API](../api/authentication.md) — the endpoints
- [API keys](./api-keys.md) — the *other* credential

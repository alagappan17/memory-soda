...
See [Projects and datasets](../concepts/projects-and-datasets.md) for the model.
...
To use it you need [an API key scoped to it](./api-keys.md).
...
[datasets](../concepts/projects-and-datasets.md) are for, and they need no
provisioning.
...
See [Project settings](./project-settings.md).
...
Full reference: [Dashboard routes](../api/dashboard.md).
...
- [Projects and datasets](../concepts/projects-and-datasets.md)

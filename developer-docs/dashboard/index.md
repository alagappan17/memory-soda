...
does goes through [`/dashboard/*` and `/auth/*`](../api/dashboard.md).
...
| Question | Page |
|---|---|
| What does the system know about this user? | [Datasets](./datasets.md) |
| Why did it extract *that*? | [Playground](./playground.md) |
| How do I issue a key for my app? | [API keys](./api-keys.md) |
| How do I change retrieval behaviour? | [Project settings](./project-settings.md) |
| Who can sign in here? | [Users and sign-in](./users-and-auth.md) |
...
printed once to the API log. See [Users and sign-in](./users-and-auth.md).
...
### [Users and sign-in](./users-and-auth.md)
...
| Delete an entire dataset | No UI and no endpoint. [Privacy and data deletion](../operations/privacy-and-deletion.md) |
...
See [Self-hosting](../operations/self-hosting.md).

---

## Next

- [Datasets](./datasets.md) — inspect what was learned
- [Playground](./playground.md) — watch the pipeline run

...
| Property | Type | Docs |
|---|---|---|
| `.threads` | `ThreadClient` | [threads](./threads.md) |
| `.workingMemory` | `WorkingMemoryClient` | [working memory](./working-memory.md) |
| `.semantic` | `SemanticMemoryClient` | [semantic memory](./semantic-memory.md) |
...
Concepts: [Retrieval](../concepts/retrieval.md) · API: [`POST /v1/memory/recall`](../api/recall.md)
...
- [`client.threads`](./threads.md)
- [`client.workingMemory`](./working-memory.md)

...
- The extraction pipeline loads **all live facts for a dataset** into process
  ...
  extraction run. See [Limits](../reference/limits.md).
...
[Tuning retrieval](../guides/tuning-retrieval.md#autoepisodeintervalms-10000--the-cost-lever).
...
- [Background jobs](./background-jobs.md)
- [Privacy and data deletion](./privacy-and-deletion.md)

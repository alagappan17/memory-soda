...
[`POST …/episodes/:id/retry`](../api/episodic-memory.md).
...
- [The extraction pipeline](../concepts/extraction-pipeline.md) — what these jobs run
- [Self-hosting](./self-hosting.md)
- [Episodic memory API](../api/episodic-memory.md) — manual retries

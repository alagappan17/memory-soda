...
- [Point-in-time recall](../guides/point-in-time-recall.md) — practical uses of `asOf`
- [The extraction pipeline](./extraction-pipeline.md) — where contradictions are judged

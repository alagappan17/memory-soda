...
block, and the entity-anchored [retrieval](./retrieval.md) signal.
...
**For a prompt** — use [`recall()`](../api/recall.md):
...
[extraction pipeline](./extraction-pipeline.md) running over messages you append
to a thread.
...
- [The bi-temporal model](./bi-temporal-model.md) — why there are four timestamps
- [Retrieval](./retrieval.md) — how facts are found and ranked
- [The extraction pipeline](./extraction-pipeline.md) — how they are created

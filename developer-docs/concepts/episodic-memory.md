...
`semanticStatus` drives the [extraction pipeline](./extraction-pipeline.md) and
...
[Episodic memory API](../api/episodic-memory.md).
...
- [Semantic memory](./semantic-memory.md) — the durable fact store
- [The extraction pipeline](./extraction-pipeline.md) — how an episode becomes facts

...
Base paths: `/auth` and `/dashboard` · Auth: [session token](./authentication.md#dashboard-sessions)
...
Bounds are in [Project settings](../reference/project-settings.md).
...
Same shape as [`GET /v1/…/facts`](./semantic-memory.md).

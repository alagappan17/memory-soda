...
Facts are grouped by [anchor entity](../concepts/semantic-memory.md#the-anchor)
...
See [Retrieval](../concepts/retrieval.md).
...
See [Point-in-time recall](../guides/point-in-time-recall.md).
...
- [Semantic memory API](./semantic-memory.md) — unranked reads

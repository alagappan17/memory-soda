...
| Endpoint | Page |
|---|---|
| `POST /v1/threads`, `GET/PATCH /v1/threads/:id`, `POST /v1/threads/:id/end` | [Threads](./threads.md) |
| `POST/GET …/threads/:id/messages`, `…/prepare`, `…/chat`, `…/compact`, `…/stats` | [Working memory](./working-memory.md) |
| `POST /v1/memory/recall` | [Recall](./recall.md) |
| `GET/DELETE …/semantic/datasets/:dataset/facts`, `…/entities` | [Semantic memory](./semantic-memory.md) |
| `GET/DELETE/POST …/episodic/…` | [Episodic memory](./episodic-memory.md) |
| `/auth/*`, `/dashboard/*` | [Dashboard routes](./dashboard.md) |
| `GET /health` | below |

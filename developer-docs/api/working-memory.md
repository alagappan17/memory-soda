...
Base path: `/v1/memory/working` · Auth: [API key](./authentication.md)

SDK equivalent: [`client.workingMemory`](../sdk/working-memory.md)
...
> **Demo endpoint.** It exists for the [Playground](../dashboard/playground.md)
...
- [Recall API](./recall.md) — long-term memory

# Curating and correcting memory
...
Or use the [Datasets](../dashboard/datasets.md) page, which has a delete control
on each row.
...
See [Point-in-time recall](./point-in-time-recall.md).
...
| Bulk delete a dataset | [Privacy and data deletion](../operations/privacy-and-deletion.md) |
...
- [Point-in-time recall](./point-in-time-recall.md)

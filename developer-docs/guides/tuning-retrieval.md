...
1. **Build a fixture.** One dataset with a realistic profile — 15–30 facts across
   ...
   [Playground](../dashboard/playground.md) is ideal.
...
The [entity-anchor signal](../concepts/retrieval.md#signal-2--entity-anchor) is
...
Check the [Entities](../dashboard/datasets.md) tab for near-duplicates before
touching this.
...
| | |
|---|---|
| Facts about anything other than the user | Extraction discards them by design — [why](../concepts/semantic-memory.md#every-fact-is-about-the-user) |
...
- [Retrieval](../concepts/retrieval.md) — how ranking works
- [Project settings](../reference/project-settings.md) — bounds and validation
- [Playground](../dashboard/playground.md) — where to experiment

...
Full explanations: [Project settings](./project-settings.md).
...
| Concurrent API instances | **One** — see [Background jobs](../operations/background-jobs.md#single-instance) |
...
- [Self-hosting](../operations/self-hosting.md) — sizing
- [Background jobs](../operations/background-jobs.md) — monitoring

...
- UI: [Project settings](../dashboard/project-settings.md)
...
Control the [entity-anchor signal](../concepts/retrieval.md#signal-2--entity-anchor):
...
- [Tuning retrieval quality](../guides/tuning-retrieval.md)
- [Project settings UI](../dashboard/project-settings.md)

...
See [Error handling](../sdk/errors.md).
...
see [Background jobs](../operations/background-jobs.md#monitoring).
...
- [SDK error handling](../sdk/errors.md)
- [API conventions](../api/index.md)
- [Background jobs](../operations/background-jobs.md) — monitoring silent failures
